#include "anwpch.h"
#include "Anwar/Renderer/EditorCamera.h"
...
namespace Anwar
{
    ...
    void EditorCamera::OnEvent(Event& e)
    {
        ...
        dispatcher.Dispatch<MouseScrolledEvent>(ANW_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
    }
    ...
    std::pair<float, float> EditorCamera::PanSpeed() const
    {
        ...
        float xFactor = 0.0366f * (x * x) - 0.1778 * x + 0.3021;
        float y = std::min(m_ViewportHeight / 1000.0f, 2.4f);
        float yFactor = 0.0366f * (y * y) - 0.1778 * y + 0.3021;
