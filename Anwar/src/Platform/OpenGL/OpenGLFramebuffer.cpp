...
namespace Anwar
{
    ...
    namespace Utils
    {
        ...
        static bool IsDepthFormat(FramebufferTextureFormat format)
        {
            switch (format)
            {
                case Anwar::FramebufferTextureFormat::DEPTH24STENCIL8:
                    return true;
            }
            return false;
        }
    ...
    void OpenGLFramebuffer::Invalidate()
    {
        ...
        {
            ANW_CORE_ASSERT(m_ColorAttachments.size() <= 4);
        ...
        ANW_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
    ...
    void OpenGLFramebuffer::Resize(uint32_t width, uint32_t height)
    {
        ...
        {
            ANW_CORE_WARN("Attempted to resize framebuffer to {0}, {1}", width, height);
            return;
        }
